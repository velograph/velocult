<?php
/**
 * Velocult functions and definitions
 *
 * @package Velocult
 */
...
if ( ! function_exists( 'velocult_setup' ) ) :
/**
 ...
 */
function velocult_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Velocult, use a find and replace
	 * to change 'Velocult' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'velocult', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'velocult' ),
	) );
...
endif; // velocult_setup
add_action( 'after_setup_theme', 'velocult_setup' );
 ...
 */
function velocult_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'velocult' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'velocult_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'velocult_scripts' );
